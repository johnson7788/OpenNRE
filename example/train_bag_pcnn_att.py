...
def doargs():
    ...
    # Data
    parser.add_argument('--metric', default='acc', choices=['micro_f1', 'acc'], help='选择best checkpoint时使用哪个 Metric')
...
def dotest(ckpt):
    ...
    if torch.cuda.is_available():
        ...
        myframe.load_state_dict(torch.load(ckpt, map_location='cpu')['state_dict'])
